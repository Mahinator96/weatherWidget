import { calculateDewPoint, convertPressure, getCurrentDateTime, getWeatherForecastData, getWindDirecion } from "./utils.js";
		...
		`
			<div class="widget__other">
				<div class="widget__wind">
					...
					<p class="widget__wind-text" style="">&#8595;</p>
...
const renderWidgetForecast = (widget, data) => {
	...
	console.log('renderWidgetForecast-Data');
	console.log(data);
	...
	const items = forecastData.map((item) => {
		...
		widgetDayItem.insertAdjacentHTML('afterbegin', 
			`
...
export {renderWidgetToday, renderWidgetOther, renderWidgetForecast, showError};